...
func MessariData(apiKey string) {
	...
	req, err := http.NewRequest("GET", "https://data.messari.io/api/v1/markets/kraken-btc-usd/metrics/price/time-series?start=2022-04-21&end=2022-05-06&interval=1d", nil)
	if err != nil {
